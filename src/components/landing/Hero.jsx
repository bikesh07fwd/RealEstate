  ...
  return (
    <>
      <div className="flex">
        ...
        <div ref={imgRef} className="bg-red-950 w-1/2 h-srceen    rounded-2xl bg-[url('https://images.pexels.com/photos/1334605/pexels-photo-1334605.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')] bg-cover bg-center flex flex-col justify-between text-white">
          <div className="flex justify-between font-bold my-6 mx-5" ref={rightRef}>
            <h2 className="text-sm w-36">More than 1500 real estate Properties</h2>
            <h3 className="text-sm w-40">
              From $145,000 with a yield of 10% per annum
            </h3>
            <span>
              
            <i class="fa-solid fa-right-to-bracket border-2 p-3 rounded-2xl"></i>
            </span>
          </div>
